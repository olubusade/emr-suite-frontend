...
import { BillFormDialogComponent } from "src/app/shared/components/dialogs/bill-form-dialog/bill-form-dialog.component";
  ...
  implements OnInit
{
  ...
  exampleDatabase: BillListService | null;
  ...
  deleteItem(row) {
    ...
    /* const dialogRef = this.dialog.open(DeleteBillDialogComponent, {
      data: row,
      direction: tempDirection,
    });
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
